...
import ProfessionalSummaryForm from "../components/ProffesionalSummaryForm";
                ...
                <div className="flex items-center gap-2">
                  ...
                  {activeSectionIndex > 0 && (
                    <button
                      ...
                      className="flex items-center gap-1 p-2 rounded-lg text-sm text-gray-600 hover:bg-gray-50"
                    >
          ...
          <div className="lg:col-span-7 max-lg:mt-6">
            <div className="relative w-full">
              <div className="absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2">
                {resumeData.public && (
                  <button
                      onClick={handleShare}className="flex items-center p-2 px-4 gap-2 text-xs
